...
#Other resources: https://pandas-datareader.readthedocs.io/en/latest/remote_data.html
...
def get_data(data_prefix, start_date, end_date):
    ...
    Parameters
    ----------
    data_prefix:    str - String object describing path to where the data is located.
    start_date:     str - String object describing the first date to consider
    end_date:       str - String object describing the last date to consider
...
###############################################################################
# Path to directory where the data is saved
data_prefix = "D:\\test\\Python\\stock_analysis\\files\\"
...
start_date = datetime.date(2018, 8, 20) # Year-Month-Day
end_date   = datetime.date(2019, 8, 20)
...
def get_SMA(close_data, time_period):
    ...
    Parameters
    ----------
    close_data: Pandas Series   Pandas Series object containing the close data (1-dimensional)
    time_period : int           Number of days to consider for the SMA

    Returns
    ----------
    SMA: Pandas Series          Pandas Series object that contains the simple moving average for the close_data.
